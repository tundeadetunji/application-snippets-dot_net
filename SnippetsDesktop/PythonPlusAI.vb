...
#End Region
Public Class PythonPlusAI
#Region "Fields"
    Private s As New iNovation.iNCode.PythonML()
...
#End Region
    Private Sub PythonPlusAI_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'language
        'MarkLanguage()
    ...
    Private Sub dCode_SelectedIndexChanged(sender As Object, e As EventArgs) Handles dCode.SelectedIndexChanged
        ...
        Select Case Content(d)
            Case iNovation.iNCode.PythonML.Components.KNNSample.ToString
                r = s.KNNSample
        End Select
        tSnippet.Text = r
